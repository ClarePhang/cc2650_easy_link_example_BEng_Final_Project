...
#define _TYPE_CMD_RADIO_SETUP_mode                              uint16_t
#define _BITPOS_CMD_RADIO_SETUP_mode_radioMode                  0
#define _NBITS_CMD_RADIO_SETUP_mode_radioMode                   15
#define _BITPOS_CMD_RADIO_SETUP_mode_bNoFsPowerUp               15
#define _NBITS_CMD_RADIO_SETUP_mode_bNoFsPowerUp                1
#define _POSITION_CMD_RADIO_SETUP_pRegOverride                  16
#define _TYPE_CMD_RADIO_SETUP_pRegOverride                      uint32_t*
#define _LAST_POSITION_CMD_RADIO_SETUP                          16
...
#define _BITPOS_CMD_FS_synthConf_divider                        1
#define _NBITS_CMD_FS_synthConf_divider                         4
...
#define _POSITION_CMD_FS_coarsePrecal                           20
#define _TYPE_CMD_FS_coarsePrecal                               uint8_t
#define _POSITION_CMD_FS_midPrecal                              21
...
#define _POSITION_CMD_READ_FS_CAL_coarseCal                     2
#define _TYPE_CMD_READ_FS_CAL_coarseCal                         uint8_t
#define _POSITION_CMD_READ_FS_CAL_midCal                        3
#define _TYPE_CMD_READ_FS_CAL_midCal                            uint8_t
#define _POSITION_CMD_READ_FS_CAL_tdcCal                        4
#define _TYPE_CMD_READ_FS_CAL_tdcCal                            uint16_t
#define _LAST_POSITION_CMD_READ_FS_CAL                          4
