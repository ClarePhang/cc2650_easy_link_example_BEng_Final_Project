...
/// Interrupt masks for the CPE interrupt in RDBELL. These interrupts apply to 15.4 only and come in
/// addition to the ones defined in mailbox.h.
///@{
#define IRQN_IEEE_BG_COMMAND_SUSPENDED 4
#define IRQN_IEEE_TX_FRAME             5
#define IRQN_IEEE_TX_ACK               6

#define IRQN_IEEE_RX_FRAME             16
#define IRQN_IEEE_RX_NOK               17
#define IRQN_IEEE_RX_IGNORED           18
#define IRQN_IEEE_RX_BUF_FULL          19
#define IRQN_IEEE_RX_ENTRY_DONE        20
