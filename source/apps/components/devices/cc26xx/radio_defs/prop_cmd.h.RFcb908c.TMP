...
#define _BITPOS_CMD_PROP_RX_pktConf_bRepeat                     1
#define _NBITS_CMD_PROP_RX_pktConf_bRepeat                      1
#define _BITPOS_CMD_PROP_RX_pktConf_endType                     2
...
#define _BITPOS_CMD_PROP_RX_pktConf_addressMode                 5
#define _NBITS_CMD_PROP_RX_pktConf_addressMode                  2
...
#define _BITPOS_CMD_PROP_RX_ADV_pktConf_bRepeat                 1
#define _NBITS_CMD_PROP_RX_ADV_pktConf_bRepeat                  1
#define _BITPOS_CMD_PROP_RX_ADV_pktConf_endType                 2
...
#define _BITPOS_CMD_PROP_RX_ADV_pktConf_bDualSw                 6
#define _NBITS_CMD_PROP_RX_ADV_pktConf_bDualSw                  1
...
#define _BITPOS_CMD_PROP_RADIO_SETUP_symbolRate_bNoFsPowerUp    31
#define _NBITS_CMD_PROP_RADIO_SETUP_symbolRate_bNoFsPowerUp     1
...
#define _POSITION_CMD_PROP_RADIO_SETUP_pRegOverride             24
#define _TYPE_CMD_PROP_RADIO_SETUP_pRegOverride                 uint32_t*
#define _LAST_POSITION_CMD_PROP_RADIO_SETUP                     24
...
typedef struct {
   ...
   struct {
      ...
      //PG 2.0 this field should be 1 bit long
      //uint32_t :2;
      uint32_t :1;
      //PG 2.0 this field should be 2 bits long and is not used for the FS Powerup CMD
      //uint32_t bNoFsPowerUp:1;
      uint32_t :2;
   } symbolRate;
   uint8_t rxBw;
   struct {
   ...
   struct {
      ...
      uint16_t fecMode:4;
      //PG 2.0 this field is called bDigitalAgc
      uint16_t bOuterCode:1;
      //PG 2.0 this field is 3 bits long
      uint16_t whitenMode:3;
      //uint16_t whitenMode:2;
      //PG 2.0 this field does not exist
...
#define _POSITION_CMD_PROP_SET_LEN_payloadLen                   0
#define _TYPE_CMD_PROP_SET_LEN_payloadLen                       uint16_t
